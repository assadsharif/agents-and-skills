...
- Python 3.11+ (matches existing codebase) + FastAPI 0.100.0 (existing), Pydantic 2.0 (existing), pydantic-settings 2.0 (existing) — no new external dependencies (002-user-authentication)
